                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h5 class="h3 text-custom mb-0">Sales value</h5>
                            </div>
                            <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <div class="chart">
                            ...
                            <canvas id="chart-sales-dark" class="chart-canvas chartjs-render-monitor"
                                style="display: block; height: 350px; width: 547px;" width="1094" height="700"></canvas>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h5 class="h3 text-custom mb-0">Total orders</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="chart">
                            ...
                            <canvas id="chart-bars" class="chart-canvas chartjs-render-monitor"
                                style="display: block; height: 350px; width: 234px;" width="468" height="700"></canvas>
                        </div>
                    </div>
                </div>
            </div>
